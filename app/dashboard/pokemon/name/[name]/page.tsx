...
export default async function PokemonPageName({ params }: Props) {
	...
	return (
		<div className="flex don-edman mt-5 flex-col items-center text-slate-800">
			<div className="relative flex flex-col items-center rounded-[20px] w-[700px] mx-auto bg-white bg-clip-border  shadow-lg  p-3">
				<div className="mt-2 mb-8 w-full">
					...
					<div className="flex flex-col justify-center items-center">
						...
						<div className="flex flex-col justify-center items-center">
							<p>Frenzhy Height: {pokemon.height}</p>
							<p>Frenzhy Weight: {pokemon.weight}</p>
						</div>
						...
						<div className="flex flex-wrap gap-1 justify-center">
							{pokemon.moves.map((move) => (
								<p
									key={move.move.name}
									className="mr-2 capitalize bg-cyan-500 px-3 rounded"
								>
									{move.move.name}
								</p>
							))}
